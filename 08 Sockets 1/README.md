...
[Download](/Examples/Server.java) and run the Echo Server example from the presentation.

[Download](/Examples/Client.java) the Client and run it. 
...
[Protocol](/Images/Echo%20Server%20Protocol.png)
